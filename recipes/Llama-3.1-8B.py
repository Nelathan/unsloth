...
del ds_all, ds_split, sugarquill, gutenberg1, gutenberg2, gutenberg3, short_story, kalo_claude_writing, gryphe_writing, claude_unslop
...
trainer_stats = trainer.train(resume_from_checkpoint = True) # Buggy gradient accumulation
